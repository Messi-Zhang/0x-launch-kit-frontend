...
import { DEFAULT_BASE_PATH, ERC20_APP_BASE_PATH, ERC721_APP_BASE_PATH, STEADY_APP_BASE_PATH, LOGGER_ID } from './common/constants';
import { AppContainer } from './components/app';
import { Erc20App } from './components/erc20/erc20_app';
import { Erc721App } from './components/erc721/erc721_app';
import { SteadyApp } from './components/steady/steady_app';
import './index.css';
        ...
        <ConnectedRouter history={history}>
            <AppContainer>
                <Switch>
                    ...
                    <Route path={STEADY_APP_BASE_PATH} component={SteadyApp} />
